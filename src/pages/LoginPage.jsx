...
export default function LoginPage() {
  ...
  async function handleForgotPassword(e) {
    ...
    setError('')
    if (!email) {
      setError('Digite seu email antes de pedir a redefinição.')
      return
    }
    setLoading(true)
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-socials">
          ...
          <button type="button" className="btn-social" onClick={handleLinkedIn}>
        ...
        <p className="auth-toggle">
          {mode === 'login' ? (
            <>Não tem conta? <button type="button" onClick={() => switchMode('signup')}>Criar conta</button></>
          ) : (
            <>Já tem conta? <button type="button" onClick={() => switchMode('login')}>Entrar</button></>
          )}
        </p>
      </div>
    </div>
